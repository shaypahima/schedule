...
- **Edit limit** (3/week) applies only to immediate (outside-window) cancels and reschedules. Inside-window requests don't burn an edit on submission or on approval.
